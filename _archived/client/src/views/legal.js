  ...
  el.innerHTML = `
    <div class="max-w-4xl mx-auto px-4 py-12 pb-20">
      ...
      <div class="prose prose-invert max-w-none text-slate-300">
        ...
        <p class="mb-4">At 1ai-ads, we are committed to protecting your privacy. This policy explains how we collect, use, and safeguard your personal information and advertising data.</p>
...
export async function renderTermsService(el) {
  el.innerHTML = `
    <div class="max-w-4xl mx-auto px-4 py-12 pb-20">
      ...
      <div class="prose prose-invert max-w-none text-slate-300">
        <p class="mb-4">Last updated: 2026</p>
        <p class="mb-4">Welcome to 1ai-ads. By using our platform, you agree to these terms of service. Please read them carefully.</p>
        ...
        <p class="mb-4">1ai-ads provides an AI-powered advertising management platform. You are responsible for maintaining the confidentiality of your account and API keys.</p>
        <h2 class="text-xl font-bold text-white mt-8 mb-4">3. Limitation of Liability</h2>
        <p class="mb-4">1ai-ads shall not be liable for any indirect, incidental, special, consequential or punitive damages, or any loss of profits or revenues resulting from your ad campaigns.</p>
        <div class="mt-12 text-center">
           <a href="#/" class="text-sky-400 hover:text-sky-300 font-bold transition-colors">Back to Home</a>
        </div>
      </div>
...
export async function renderGDPR(el) {
  el.innerHTML = `
    <div class="max-w-4xl mx-auto px-4 py-12 pb-20">
      ...
      <div class="prose prose-invert max-w-none text-slate-300">
        <p class="mb-4">Last updated: 2026</p>
        <p class="mb-4">1ai-ads is fully committed to compliance with the General Data Protection Regulation (GDPR) to protect the data privacy of our European Union users.</p>
        ...
        <p class="mb-4">If you have any questions or requests regarding your data privacy, please contact our Data Protection Officer at privacy@1ai-ads.aitradepulse.com.</p>
        <div class="mt-12 text-center">
           <a href="#/" class="text-sky-400 hover:text-sky-300 font-bold transition-colors">Back to Home</a>
        </div>
      </div>
