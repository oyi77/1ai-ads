...
def create_adset_v4():
    ...
    # Optimization for Lead Generation (Direct WA usually needs specific objective pairing)
    params = {
        "name": "ADFORGE_Purwoceng_ManPower_V4",
        "campaign_id": CAMPAIGN_ID,
        "optimization_goal": "LEAD_GENERATION",  # Matching OUTCOME_LEADS objective
