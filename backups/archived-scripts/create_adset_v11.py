...
def create_adset_v11():
    url = f"https://graph.facebook.com/v19.0/{ACCOUNT_ID}/adsets"

    # Mencoba optimization goal 'LEADS' - terkadang API menggunakan nama beda dengan UI
    params = {
        "name": "ADFORGE_Purwoceng_SeniorLaki_V2",
...
if __name__ == "__main__":
    print(json.dumps(create_adset_v11(), indent=2))
