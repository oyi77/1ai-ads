 ...
 *   1. Add an entry here
 *   2. Create the service class in ../services/<platform>/index.js
...
export const PLATFORM_REGISTRY = {
  meta: {
    ...
    service: '../services/meta/index.js',
  ...
  google: {
    ...
    service: '../services/google/index.js',
  ...
  tiktok: {
    ...
    service: '../services/tiktok/index.js',
  ...
  linkedin: {
    ...
    service: '../services/linkedin/index.js',
  ...
  twitter: {
    ...
    service: '../services/twitter/index.js',
  ...
  snapchat: {
    ...
    service: '../services/snapchat/index.js',
  ...
  pinterest: {
    ...
    service: '../services/pinterest/index.js',
  ...
  microsoft: {
    ...
    service: '../services/microsoft/index.js',
  ...
  reddit: {
    ...
    service: '../services/reddit/index.js',
  ...
  spotify: {
    ...
    service: '../services/spotify/index.js',
  ...
  whatsapp: {
    ...
    service: '../services/whatsapp/index.js',
  ...
  amazon: {
    ...
    service: '../services/amazon/index.js',
  ...
  apple: {
    ...
    service: '../services/apple/index.js',
  ...
  criteo: {
    ...
    service: '../services/criteo/index.js',
  ...
  taboola: {
    ...
    service: '../services/taboola/index.js',
  ...
  thetradedesk: {
    ...
    service: '../services/thetradedesk/index.js',
  ...
  yandex: {
    ...
    service: '../services/yandex/index.js',
  ...
  baidu: {
    ...
    service: '../services/baidu/index.js',
  ...
  kakao: {
    ...
    service: '../services/kakao/index.js',
  ...
  line: {
    ...
    service: '../services/line/index.js',
