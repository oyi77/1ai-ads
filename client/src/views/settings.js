...
<main class="flex-1 p-4 sm:p-8 overflow-y-auto">
    ...
    if (state.activeSection === 'meta-ai') attachMetaAiHandlers();
    if (state.activeSection === 'ads-library-ai') attachAdsLibraryAiHandlers();
  }
  ...
  function renderSection() {
    switch (state.activeSection) {
      ...
      case 'meta-ai': return renderMetaAiSection();
      case 'ads-library-ai': return renderAdsLibraryAiSection();
      default: return '';
    }
  }
      ...
      <div class="bg-[#161b22] border border-[#30363d] rounded-xl p-6">
        ...
        <form id="meta-ai-form" class="space-y-4">
          <div>
            ...
            <input type="text" id="meta-ai-account" value="${esc(state.metaAi?.adAccountId || '')}" placeholder="e.g. 1181078009580337" class="w-full p-3 bg-[#0d1117] rounded-lg border border-[#30363d] text-white text-sm font-mono">
          ...
          <div>
            ...
            <p class="text-xs text-slate-500 mt-1">
              <strong class="text-amber-400">Risk:</strong> Cookies grant full Ads Manager access. Stored server-side in settings table. Never share.
            </p>
          </div>
  ...
  function renderAdsLibraryAiSection() {
    return `
  ...
  function attachAdsLibraryAiHandlers() {
