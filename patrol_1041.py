#!/usr/bin/env python3
"""
PROTOCOL 13 — Circuit Breaker & CPC Kill for 1041 (Nyamiresep act_380721031313330)
"""
...
CB_STATE = os.path.join('/tmp', '1041_cb_state.json')
ACC = ACCOUNTS["1041"]
ACT_ID = ACC["id"]
CAP = 300000
...
if trip_msg:
    ...
    msg = f"🛡️ 1041 — {DT().strftime('%H:%M')} | ACTIVE:{len(active)} PAUSED:{len(paused_non_off)} OFF:{off_count}/{total_camps} | Spend:Rp{spend:,}/{CAP:,}"
    if killed:
