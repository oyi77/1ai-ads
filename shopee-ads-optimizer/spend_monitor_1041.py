...
DAILY_HARD_CAP = int(os.environ.get("DAILY_HARD_CAP", "200000"))        # Hard stop at Rp 200k (NEW - data-driven reduction)
WARNING_AT = int(os.environ.get("WARNING_AT", "150000"))            # Warning at Rp 150k
AUTO_RESUME_AT = int(os.environ.get("AUTO_RESUME_AT", "100000"))        # Auto-resume when spend drops below this
