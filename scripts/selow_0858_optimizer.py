...
def run_optimizer():
    ...
    campaigns = [
        {"id": "c1", "name": "ADFORGE_RULE_ABO_Testing_Rak", "status": "ACTIVE", "spend": 10205, "clicks": 128, "impressions": 2058},
        {"id": "c2", "name": "CBO_WinningScale_BIDCAP180", "status": "ACTIVE", "spend": 12135, "clicks": 74, "impressions": 970},
        {"id": "c3", "name": "CBO_1-1-1_rakpiringpengering", "status": "ACTIVE", "spend": 4610, "clicks": 38, "impressions": 715},
    ]
    ...
    if now.minute % 30 == 0:
        avg_cpc = total_spend / sum(c['clicks'] for c in campaigns) if sum(c['clicks'] for c in campaigns) > 0 else 0
