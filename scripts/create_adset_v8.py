...
def create_adset_v8():
    ...
    # Menyamakan persis dengan campaign existing (CONVERSATIONS)
    params = {
        ...
        'promoted_object': json.dumps({
            'page_id': PAGE_ID,
            'app_id': '881378894925519' # ID tujuan WhatsApp Business (dari data audit tadi)
        }),
        'status': 'PAUSED',
...
if __name__ == "__main__":
    print(json.dumps(create_adset_v8(), indent=2))
