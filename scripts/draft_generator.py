...
DB_PATH = os.environ.get(
    "ADFORGE_DB_PATH", str(Path(__file__).resolve().parent.parent / "db" / "adforge.db")
)
...
class DraftGenerator:
    ...
    def create_draft(self, draft_type, summary, details, proposed_by="automation"):
        ...
        try:
            ...
            """,
                (draft_id, draft_type, summary, json.dumps(details), proposed_by),
            )
            self.conn.commit()
    ...
    def create_rule_draft(self, rule_id, enabled, reason):
        ...
        details = {"rule_id": rule_id, "enabled": enabled, "reason": reason}
    ...
    def create_compliance_draft(self, account_id, violation, fix_action):
        ...
        return self.create_draft(
            "campaign_change", summary, details, "compliance_checker"
        )
    ...
    def approve_draft(self, draft_id, reviewed_by="system"):
        ...
        try:
            ...
            return {"success": True, "message": f"Draft {draft_id} approved"}
        except Exception as e:
            return {"success": False, "error": str(e)}
    ...
    def reject_draft(self, draft_id, reason, reviewed_by="system"):
        ...
        try:
            ...
            return {"success": True, "message": f"Draft {draft_id} rejected"}
        except Exception as e:
            return {"success": False, "error": str(e)}
