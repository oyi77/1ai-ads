...
VIDEOS = [
    os.path.join(
        ...
        "media",
        "inbound",
        "shellalie95_2026_01_01_0613_Rebusan_akar_alang_alang_Minuman---6343e3a9-be68-4ce3-b2d7-8afbbf7563e8.mp4",
    ),
    os.path.join(
        os.path.expanduser("~"),
        ".openclaw",
        "media",
        "inbound",
        "pandajawaanimate_2026_05_03_1229_Manfaat_akar_alang_alang_Im---8592515b-2ff0-492f-8506-44124cefed62.mp4",
    ),
    os.path.join(
        os.path.expanduser("~"),
        ".openclaw",
        "media",
        "inbound",
        "darialam04_2026_05_07_1601_Jangan_Remehkan_Akar_Liar_Ini_Kha---c406d0ef-80a0-4694-9f2f-579b2116667f.mp4",
    ),
    os.path.join(
        os.path.expanduser("~"),
        ".openclaw",
        "media",
        "inbound",
        "griyasarinadisehat_2024_11_22_1021_Manfaat_akar_alang_alang_---88311ace-7c3d-4f8f-a7db-d8c87b957492.mp4",
    ),
    os.path.join(
        os.path.expanduser("~"),
        ".openclaw",
        "media",
        "inbound",
        "ssstik.io_herbarara_1778775427451---a54ab63b-4f10-48b1-b0f1-ccb6d302f79d.mp4",
    ),
    os.path.join(
        os.path.expanduser("~"),
        ".openclaw",
        "media",
        "inbound",
        "ssstik.io_mas.wied_348_1778775400762---00ff0395-4f84-42ad-9149-8fd102624217.mp4",
    ),
]
...
def run():
    ...
    for target_pid, target_token in all_pages:
        ...
        for post in posts:
            ...
            if any(
                key in msg for key in ["shopee", "order", "alang", "komisi", "harga"]
            ):
                ...
                log(
                    f"  💬 Post {p_id} ({msg[:30]}...) -> {comment_count} comments added."
                )
