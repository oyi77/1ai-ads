...
def cleanup():
    ...
    r = requests.get(
        url, params={"access_token": ACCESS_TOKEN, "fields": "id,name"}
    ).json()
    for c in r.get("data", []):
    ...
    adset_configs = [
        ...
        },
        {
            ...
            "targeting": {
                ...
                "device_platforms": ["mobile"],
                "flexible_spec": [
                    {"interests": [{"id": "6003263791114", "name": "Belanja (ritel)"}]}
                ],
                "targeting_automation": {"advantage_audience": 0},
            },
        },
...
create_purchase_campaign(
    name="CBO_PURCHASE_WEDANG_VILONA", creative_id="951263927682538"
)

# Purwoceng Creative: 1296083695381611
create_purchase_campaign(
    name="CBO_PURCHASE_PURWOCENG_VILONA", creative_id="1296083695381611"
)
