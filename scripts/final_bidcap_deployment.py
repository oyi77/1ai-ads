...
CLEAN_TARGETING = {
    ...
    "facebook_positions": [],
    "instagram_positions": ["stream", "story", "explore", "explore_grid", "reels"],
...
def final_push():
    ...
    as_payload = {
        ...
        ),  # nyamiresepdapur Page
    }

    res = requests.post(
        f"https://graph.facebook.com/v19.0/{AD_ACCOUNT_ID}/adsets", data=as_payload
    ).json()
    ...
    if "id" in res:
        ...
        # 3. Activate Campaign
        requests.post(
            f"https://graph.facebook.com/v19.0/{NEW_CAMPAIGN_ID}",
