...
def deploy_winning_post():
    ...
    cr_res = requests.post(f'https://graph.facebook.com/v11.0/{AD_ACCOUNT_ID}/adcreatives', data=creative_payload).json()
    ...
    if 'id' in cr_res:
        ...
        ad_res = requests.post(f'https://graph.facebook.com/v11.0/{AD_ACCOUNT_ID}/ads', data=ad_payload).json()
        ...
        cr_res_v2 = requests.post(f'https://graph.facebook.com/v19.0/{AD_ACCOUNT_ID}/adcreatives', data=creative_payload_v2).json()
