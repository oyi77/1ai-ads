...
BLACKLIST_KEYWORDS = [
    'kakriput', 'kancingjepit',
    'gendongananjing', 'gendongan'
]
# NOTE: organizerpullout UNBLACKLISTED 2 Jun 2026 — Shopee data shows profitable:
# Rp118/click revenue, 4.26% conversion, CPC Rp55-95 = profit Rp23-63/click
