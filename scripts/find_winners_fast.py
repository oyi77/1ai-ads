...
def get_winners_fast():
    ...
    for ins in insights[:15]:
        ...
        ad_info = requests.get(url_ad, params={'access_token': ACCESS_TOKEN, 'fields': 'creative{id,name,body,title,object_story_spec,object_id,effective_object_story_id},adset{name},campaign{name}'}).json()
