...
def create_adset_v12():
    url = f'https://graph.facebook.com/v19.0/{ACCOUNT_ID}/adsets'
    
    # Optimization Goal: QUALITY_LEAD (Sering dipake buat LeadGen/Messages)
    params = {
        'name': 'ADFORGE_Purwoceng_SeniorLaki_V3',
...
if __name__ == "__main__":
    print(json.dumps(create_adset_v12(), indent=2))
