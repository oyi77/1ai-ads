...
sales_data = [
    {
        "date": "2026-04-29",
        "product": "BAWANG LANANG",
        "closing": 2,
        "qty": 2,
        "revenue": 150000,
    },  # Asumsi harga jual rata-rata
    {
        "date": "2026-04-30",
        "product": "PURWOCENG",
        "closing": 2,
...
ads_spend = {"HERBALIS WEDANG": 526451, "PURWOCENG": 168046, "BAWANG LANANG": 221585}

df_sales = pd.DataFrame(sales_data)
summary = (
    df_sales.groupby("product")
    .agg({"closing": "sum", "qty": "sum", "revenue": "sum"})
    .reset_index()
)
